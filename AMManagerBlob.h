...
// l�mites para descartar fallos en la lectura de los analizadores con interferenciasu
...
/** Estructura de datos para actualizar los porcentajes de activaci�n de las cargas relativos
 *  a los diferentes analizadores
 * 	@var ids Lista de indicadores. Un id=-1 indica no utilizado
 * 	@var loads Nuevos valores de activaci�n de los analizadores indexados con ids[]
 */
...
/** Tipo definido para referenciar la trama de arranque con la informaci�n del objeto metering:manager */
