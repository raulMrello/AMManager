...
#ifdef CONFIG_AMMANAGER_LOG_LEVEL_ERROR
#define AMMANAGER_LOG_LEVEL		ESP_LOG_ERROR
#elif CONFIG_AMMANAGER_LOG_LEVEL_WARN
#define AMMANAGER_LOG_LEVEL		ESP_LOG_WARN
#elif CONFIG_AMMANAGER_LOG_LEVEL_INFO
#define AMMANAGER_LOG_LEVEL		ESP_LOG_INFO
#elif CONFIG_AMMANAGER_LOG_LEVEL_DEBUG
#define AMMANAGER_LOG_LEVEL		ESP_LOG_DEBUG
#elif CONFIG_AMMANAGER_LOG_LEVEL_VERBOSE
#define AMMANAGER_LOG_LEVEL		ESP_LOG_VERBOSE
#else
#define AMMANAGER_LOG_LEVEL		ESP_LOG_NONE
#endif
...
#endif
{
  public:
    ...
    /**
     * Obtiene el n�mero de errores totales de los drivers instalados
     * @return
     */
